...
if __name__=='__main__':
    ...
    with tf.Session('') as sess:
        ...
        best=1e100
        for i in range(100):
            trainloss,_, reta,retb,retc,retd,kk=sess.run([loss, train, reta,retb,retc,retd, kk])
            print(reta.shape,retb.shape,retc.shape,retd.shape,kk.shape)
            newt=time.time()
