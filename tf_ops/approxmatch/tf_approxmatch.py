...
if __name__=='__main__':
	...
	tt = match_cost(pt_in,mypoints,match)
	...
	with tf.Session('') as sess:
		...
		while True:
			...
			trainloss,trainmatch, tt_=sess.run([loss,match, tt],feed_dict={pt_in:tpoints.astype('float32')})
			print(trainmatch.shape,'=====',tt_,tt_.shape)
